...
INSERT INTO sauna_private.sauna (id, name, street_address, postal_code, city, phone, web_page, info, kiosk, restaurant) VALUES
    ('66e5f3c7-b4ac-4bc6-8e2b-19395b73ec3d', 'Alisniemen sauna', 'Porintie 584', '37130', 'Nokia',
        '+358 50 919 7050', 'https://www.alisniemi.com/', 'Kassa sulkeutuu 30 min ennen päättymisaikaa. Maksuvälineeksi suositellaan pankkikorttia. Ma klo 14-17 lempeät löylyt. Su klo 19-21 hiljainen talvisauna.', true, false);
