...
INSERT INTO sauna_private.sauna (id, name, street_address, postal_code, city, phone, web_page, info, kiosk, restaurant) VALUES
    ('73ca9aa4-01f9-4ec2-9922-df4982fe3a1e', 'Suomensaaren sauna', 'Suomensaarenkatu 9', '33410', 'Tampere',
        '', 'https://lielahdenkipina.fi/suomensaarensauna/', 'Saunalle tulee vain järvivesi, joka on hyvä huomioida ottamalla mukaan vettä juotavaksi. Kahvio.', true, false);
...
INSERT INTO sauna_private.price (id, opening_hour_id, price_type, price) VALUES
    ...
    ('7925b2bd-b258-4539-86e6-257fb7eac83a', '63913988-7a19-48f1-b8ff-7323156ca1df', 'ADULT', 10.00),
    ...
    ('030ad8e9-1b04-48a5-82b1-c33c3e45b728', 'a05dd246-4041-46e6-a0c0-a92ccb39600b', 'ADULT', 10.00),
    ...
    ('950132cf-2bd3-4dec-b2a2-a03d7359d2fc', '84b5d80f-1f4a-4d16-9faf-f8bfbad124c7', 'ADULT', 10.00),
    ...
    ('b155a4dd-ba09-4fbc-8e0c-6009f31b4162', 'dd96f997-490a-496b-bc63-f57f4690cb81', 'ADULT', 10.00),
