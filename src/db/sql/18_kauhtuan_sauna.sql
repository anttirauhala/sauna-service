...
INSERT INTO sauna_private.sauna (id, name, street_address, postal_code, city, phone, web_page, info, kiosk, restaurant) VALUES
    ...
    'Karttahakuun kannattaa laittaa Kauhtuan sauna. Yleisen saunavuoron aikana on grillikota ja sähkögrilli käytössä makkaran paistolle. Tavalliseen saunaan mahtuu n.30 henkilöä, savusaunaan n.18 henkilöä. TALVIKAUSI: Tiistai ja keskiviikko 16-21, perjantai, lauantai ja sunnuntai 15-21. HUOM: Savusaunassa on tiukemmat löylyt kaksi ensimmäistä tuntia.',
     false, false);

-- Insert winter opening hours for Kauhtuan sauna
INSERT INTO sauna_private.opening_hour (id, sauna_id, weekday, opening_time, closing_time) VALUES
    ('9791b4a1-69e1-401f-971f-39c32c6a14a6', 'ee4ee3cc-7338-4a97-ab76-2bb51af05d11', 'TUESDAY', '16:00', '21:00'),
    ('4c12e967-aa90-42d0-b6d0-07f3d47ea972', 'ee4ee3cc-7338-4a97-ab76-2bb51af05d11', 'WEDNESDAY', '16:00', '21:00'),
    ('57f83be2-3bfb-4459-b6bf-9fdf67e0bf06', 'ee4ee3cc-7338-4a97-ab76-2bb51af05d11', 'FRIDAY', '15:00', '21:00'),
    ('2308ad8c-69f0-442a-994d-51c19e5b3b03', 'ee4ee3cc-7338-4a97-ab76-2bb51af05d11', 'SATURDAY', '15:00', '21:00'),
    ('a1b2c3d4-e5f6-7890-1234-56789abcdef0', 'ee4ee3cc-7338-4a97-ab76-2bb51af05d11', 'SUNDAY', '15:00', '21:00');

-- Insert prices for Kauhtuan sauna (winter schedule)
INSERT INTO sauna_private.price (id, opening_hour_id, price_type, price) VALUES
    ...
    ('b2c3d4e5-f6a7-8901-2345-6789abcdef01', 'a1b2c3d4-e5f6-7890-1234-56789abcdef0', 'ADULT', 9.00),
    ('c3d4e5f6-a7b8-9012-3456-789abcdef012', 'a1b2c3d4-e5f6-7890-1234-56789abcdef0', 'CHILD', 2.00);