...
INSERT INTO sauna_private.sauna (id, name, street_address, postal_code, city, phone, web_page, info, kiosk, restaurant) VALUES
    ...
    'Karttahakuun kannattaa laittaa Kauhtuan sauna. Yleisen saunavuoron aikana on grillikota ja sähkögrilli käytössä makkaran paistolle. Tavalliseen saunaan mahtuu n.30 henkilöä, savusaunaan n.18 henkilöä. KESÄKAUSI (5.5.-31.8.): Vain keskiviikkoisin tavallinen ja savusauna auki. HUOM: Savusaunassa on tiukemmat löylyt kaksi ensimmäistä tuntia. Seuraava talviajan sauna la 6.9.-25.',
     false, false);

-- Insert summer opening hours for Kauhtuan sauna (5.5.-31.8.)
...
-- Insert prices for Kauhtuan sauna (summer schedule)
