...
INSERT INTO sauna_private.sauna (id, name, street_address, postal_code, city, phone, web_page, info, kiosk, restaurant) VALUES
    ...
    'Saunarakennuksessa on yhteinen takkatupa ja kaksi saunaa ja pukuhuonetta. Vain käteinen! TALVIKAUSI (alkaen 4.8.2025): Kaikille avoimet saunavuorot maanantaisin ja keskiviikkoisin 17-20, lauantaisin 14-18.', true, false);

-- Insert winter opening hours for Reipin sauna (starting 4.8.2025)
...
-- Insert prices for Reipin sauna (winter schedule)
