...
public class SaunaRepository implements ISaunaRepository {
    ...
    public List<Sauna> findAll() {
        String sql = "SELECT " +
                ...
                "sauna_private.sauna.phone, sauna_private.sauna.web_page, sauna_private.sauna.info, " +
                "sauna_private.sauna.kiosk, sauna_private.sauna.restaurant, " +
                ...
                "ORDER BY name ASC, weekday ASC, opening_time ASC, price_type ASC";
